...
public class InventoryController {
    ...
    private void addAlbum() {
        try {
            ...
            showAlert(AlertType.ERROR, "Kesalahan isi data", "Masukkan data yang benar");
        } catch (IllegalArgumentException e) {
            showAlert(AlertType.ERROR, "Kesalahan isi data", e.getMessage());
        }
    }
    ...
    private void deleteAlbum() {
        try {
            ...
            showAlert(AlertType.ERROR, "Error", "Error mendelete album.");
        }
    }
    ...
    private void rentAlbum() {
        try {
            ...
            if (selectedAlbum.getAvailable() > 0) {
                ...
                showAlert(AlertType.WARNING, "Tidak Ada Salinan", "Tidak ada salinan album yang dipilih.");
            }

        } catch (Exception e) {
            showAlert(AlertType.ERROR, "Error", "Error menyewa album.");
        }
    }
